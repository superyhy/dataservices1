    ...
    <div style="padding: 15px;">
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
              <form class="layui-form" action="" id="queryRoleForm">
                  <input id="pageNum" type="hidden" name="pageNum">
                  <input id="pageSize" type="hidden" name="pageSize">
                <div class="layui-form-item" style="text-align:center;">
                  <div class="layui-inline">
                    <div class="layui-input-inline">
                      <input id="cityName" autocomplete="off" class="layui-input" placeholder="请输入名称" type="text" name="name" value="">
                    </div>
                  </div>
              ...
              <div class="layui-btn-group">
                  <button type="button" class="layui-btn layui-btn-xs layui-btn-normal dw-dailog" dw-url="/gotoAddRole" dw-title="新增数据" dw-width="90%" dw-height="90%">
...
<script type="text/javascript" src="../../js/access/roleList.js"></script>
</body>
</html>