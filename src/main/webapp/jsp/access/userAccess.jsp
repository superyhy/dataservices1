    ...
    <div style="padding: 15px;">
        <fieldset class="layui-elem-field">
            ...
            <div class="layui-field-box">
              <form class="layui-form" action="" id="queryUserAccessForm">
                  <input id="pageNum" type="hidden" name="pageNum">
                  <input id="pageSize" type="hidden" name="pageSize">
                <div class="layui-form-item" style="text-align:center;">
                  <div class="layui-inline">
                    <div class="layui-input-inline">
                      <input id="cityName" autocomplete="off" class="layui-input" placeholder="请输入用户名" type="text" name="userName" value="">
                    </div>
                  </div>
...
<script type="text/javascript" src="../../js/access/userAccess.js"></script>
</body>
</html>